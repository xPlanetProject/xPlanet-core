...
contract TempERC20 is IERCMint20 {
    using SafeMath for uint;

    string public name;
    string public symbol;
    uint8 public decimals;
    uint public max_mint_number ;
    uint public max_pre_number;
    ...
    constructor(string memory _symbol ,uint8 _decimals) public {
        ...
        decimals = _decimals;
        name = _symbol;
        max_mint_number = 1000000000 * (10 ** uint(decimals));
        max_pre_number = 400000000 * (10 ** uint(decimals));
